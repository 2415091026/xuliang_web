  ...
  >
    ...
    <header class="relative z-[70]">
      ...
      >
        ...
        <span
          aria-hidden="true"
          class="pointer-events-none absolute -left-16 -top-20 z-0 h-36 w-96 rotate-[-16deg] rounded-full bg-white/10 blur-2xl"
        ></span>
        <span
          aria-hidden="true"
          class="pointer-events-none absolute right-24 top-1 z-0 h-12 w-64 rounded-full bg-[#63d7e7]/10 blur-xl"
        ></span>
        <span
          aria-hidden="true"
        ...
        <span
          aria-hidden="true"
          class="pointer-events-none absolute left-8 right-8 top-0 z-0 h-px bg-white/45"
        ></span>
        <RouterLink class="relative z-10 flex min-w-[136px] items-center gap-[11px] max-[620px]:min-w-0" to="/" aria-label="首页">
          <span class="grid size-[38px] place-items-center rounded-full border border-white/30 bg-white/[0.075] text-xs font-black text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.52),inset_0_-8px_14px_rgba(255,255,255,0.055),0_8px_24px_rgba(255,79,63,0.16)] backdrop-blur-2xl">
            XL
          </span>
          <span class="grid gap-0.5">
            <strong class="font-serif text-[22px] leading-none">徐良</strong>
            <span class="text-[10px] font-black text-[#fff8ea]/45 max-[620px]:hidden">
              OFFICIAL SITE
            </span>
          </span>
        </RouterLink>
        ...
        <div class="relative z-10 flex justify-center gap-1 max-[920px]:hidden">
          ...
          >
            <a
              ...
              :class="navLinkClass(isExactActive)"
              @click="navigate"
            >
              {{ item.label }}
            </a>
        ...
        <RouterLink
          ...
          to="/music"
        >
          <span class="relative z-10">开始听</span>
        </RouterLink>
      </nav>
    </header>
    ...
    <footer class="bg-[#050609] px-[max(24px,calc((100vw_-_1180px)/2))] pb-8 pt-20 max-[620px]:px-[18px]">
      <div class="grid items-end gap-9 min-[921px]:grid-cols-[minmax(0,1fr)_auto]">
        <div>
          <p class="mb-3 text-xs font-black uppercase text-[#f2b84b]">
            Keep Listening
          </p>
          <h2 class="m-0 font-serif text-[clamp(40px,6vw,84px)] font-black leading-[0.96] text-[#fff8ea]">
            继续听他的歌
          </h2>
          <p class="mt-[18px] max-w-[640px] text-base leading-8 text-[#fff8ea]/70">
            这里承接音乐平台、社交入口和版权信息。
          </p>
        </div>

        <div class="flex flex-wrap gap-2.5 min-[921px]:justify-end">
          <a class="rounded-full border border-white/15 px-3.5 py-2.5 text-[13px] font-black text-[#fff8ea]/70 transition hover:border-[#f2b84b]/50 hover:text-[#fff8ea] focus-visible:border-[#f2b84b]/50 focus-visible:text-[#fff8ea] focus-visible:outline-none" href="#">微博</a>
          <a class="rounded-full border border-white/15 px-3.5 py-2.5 text-[13px] font-black text-[#fff8ea]/70 transition hover:border-[#f2b84b]/50 hover:text-[#fff8ea] focus-visible:border-[#f2b84b]/50 focus-visible:text-[#fff8ea] focus-visible:outline-none" href="#">抖音</a>
          <a class="rounded-full border border-white/15 px-3.5 py-2.5 text-[13px] font-black text-[#fff8ea]/70 transition hover:border-[#f2b84b]/50 hover:text-[#fff8ea] focus-visible:border-[#f2b84b]/50 focus-visible:text-[#fff8ea] focus-visible:outline-none" href="#">B站</a>
          <a class="rounded-full border border-white/15 px-3.5 py-2.5 text-[13px] font-black text-[#fff8ea]/70 transition hover:border-[#f2b84b]/50 hover:text-[#fff8ea] focus-visible:border-[#f2b84b]/50 focus-visible:text-[#fff8ea] focus-visible:outline-none" href="#">网易云</a>
          <a class="rounded-full border border-white/15 px-3.5 py-2.5 text-[13px] font-black text-[#fff8ea]/70 transition hover:border-[#f2b84b]/50 hover:text-[#fff8ea] focus-visible:border-[#f2b84b]/50 focus-visible:text-[#fff8ea] focus-visible:outline-none" href="#">QQ音乐</a>
        </div>
      </div>
    </footer>
  </div>
